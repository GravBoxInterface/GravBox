...
class InteractionScreen(Screen): #This is the main screen for drawing and user input. Next steps include nesting layouts and adding/binding buttons
    ...
    def __init__(self, **kwargs):
        ...
        self.homeImage = Image(source=assetsdirectory+str('explosion1.png')) # adds slightly transparent home icon over the back button 
        ...
        objButton = Spinner(text='PLEASE SELECT\nAN OBJECT', halign='center', font_size='18', values=('Particle', 'Planet', 'Comet', 'Star', 'Black Hole', 'Elephant')) # object spinner
        ...
        # SPEED LABEL
        self.spdLabel = Label(text= 'Speed:\n' + str(drawUtility.speed), font_size='20', halign='center') # label showing current speed
        ...
        # ANGLE LABEL
        self.angLabel = Label(text='Angle:\n' + str(drawUtility.angle), font_size='20', halign='center') # label showing current angle
